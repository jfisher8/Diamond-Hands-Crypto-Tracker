...
ThemeData lightMode = ThemeData(
  ...
  textTheme: TextTheme(
    ...
    titleLarge: GoogleFonts.questrial(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.black),
...
ThemeData darkMode = ThemeData(
  brightness: Brightness.dark,
    textTheme: TextTheme(
    titleSmall: GoogleFonts.questrial(fontWeight: FontWeight.bold, fontSize: 16, color: const Color.fromRGBO(56, 182, 255, 1.0)),
    titleMedium: GoogleFonts.questrial(fontWeight: FontWeight.bold, fontSize: 18, color: Colors.grey[400]),
